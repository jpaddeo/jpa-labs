function checkLength(obj, objid, min, max) {
...
function checkRegexp(obj, regexp, objid) {
...
function emailValido (obj, objid) {
    ...
    var vLong = checkLength(obj, objid, 3, 100);
    var vRegExp = checkRegexp(obj, regEmail, objid);
    
    return (vLong && vRegExp);
}
